...
<html lang="rlt">
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <span class="tableName">عرض سجل الأخصائيين</span>
                <div class="table">
                    <?php
                        $req = new Request();
                        $apilink = "$link/select/*/Employee/where/specialty/!=/none/true";
                ...
                <div class="button btn" dir="rtl">
                       <a href="تعديل بيانات اخصائي.php">
                        <button class="edietDe"> تعديل بيانات</button> 
                    </a>
                    <a href="أختر قسم الأخصائيين.html">
