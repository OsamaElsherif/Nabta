...
<html lang="rlt">
    <head>
     ...
     <title>تعديل بيانات أخصائي </title>
        ...
        <div class="container">
            <div class="navbar" dir="rtl">
                <div class="logo">
                 ...
                 <?php
                    ...
                    $create_navbar = $navbar->CreateNavbar('spicialest');
                    print($create_navbar);
                 ?>
                 <div class="out">
            ...
            <div class="content">
                ...
                <div class="edpage" dir="rtl">
                    <form id="search" method='post' action="تعديل بيانات اخصائي.php">
                        <div class="input-box">
                    ...
                    <form class="edform" action="تعديل بيانات اخصائي.php" method='post'>
                    <?php
                            $nid = '';
                            $name = '';
                            $phone = '';
                        ...
                        if (isset($_POST['search'])) {
                                $fid = $_POST['id'];
                                $request = new Request();
                                $api_link = "$link/select/*/Employee/where/employee_ID/=/$fid/fasle";
