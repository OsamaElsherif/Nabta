...
if(isset($_POST['add'])) {
    ...
    // insert a employee
    $api_link = "$link/insert/Employee/values/'$PName', $gender, '$mobnum','$address','$date', $department_ID,'none', $user_id";
    $create = $request->Create($api_link);
    if (!$create[0]) {
        die("ERR in API Request");
    }
                           ...
                           <div>
                            ...
                            <div>
                                <div class="input-box">
                                    ...
                                    <input type="password" name="confirm_password" placeholder=" كلمة المرور" required>
                                </div>
